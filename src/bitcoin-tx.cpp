...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s weacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  weacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded weacoin transaction") + "\n" +
              "  weacoin-tx [options] -create [commands]   " + _("Create hex-encoded weacoin transaction") + "\n" +
              "\n";
