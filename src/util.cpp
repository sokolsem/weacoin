...
const char * const BITCOIN_CONF_FILENAME = "weacoin.conf";
const char * const BITCOIN_PID_FILENAME = "weacoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Weacoin";
#else
    // Unix
