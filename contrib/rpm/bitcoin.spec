...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 31015
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 31016
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 41015
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 41016
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 31015
	%{_sbindir}/semanage port -d -p tcp 31016
	%{_sbindir}/semanage port -d -p tcp 41015
	%{_sbindir}/semanage port -d -p tcp 41016
