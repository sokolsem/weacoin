...
* weacoin.conf: contains configuration settings for weacoind or weacoin-qt
* weacoind.pid: stores the process id of weacoind while running
...
* debug.log: contains debug information and general logging generated by weacoind or weacoin-qt
